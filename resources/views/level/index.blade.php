...
@section('content')
    <div class="container-fluid">
        ...
        {{-- <a class="btn btn-large btn-primary mt-1 float-right fw-bold fs-5"
            href="{{ url('level/create') }}"><strong>Tambah</strong></a> --}}


        <a href="{{ url('level/create') }}" class="btn  btn-large btn-primary mt-1 float-right fw-bold fs-5">
        ...
        <br><br>
        <table class="table table-hover shadow " style="border: 1px solid black" id="table_level">
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            //     e.preventDefault();
            //     $.ajax({
            //         url: "{{ url('level/') }}", // Ganti dengan URL tujuan Anda
            //         method: 'post',
            //         data: $(this).serialize(),
